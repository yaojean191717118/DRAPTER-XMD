const {
  ...
  const ownerNumber = ['254725474072']
...
const sessdata = config.SESSION_ID.replace("nector~", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = `*✨ Hello, THE HUB Legend! ✨*

╭─〔 *🤖 THE HUB BOT* 〕  
├─▸ *Simplicity. Speed. Power. BY ⓃⒺCⓉOR🍯!*  
╰─➤ *Your New WhatsApp Sidekick is Here!*

*❤️ Thank you for Choosing THE HUB!*

╭──〔 🔗 *Quick Links* 〕  
├─ 📢 *Join Our Channel:*  
│   Click [**Here**](https://whatsapp.com/channel/0029VadQrNI8KMqo79BiHr3l) to join!  
├─ ⭐ *Give Us a Star:*  
│   Star Us [**Here**](https://github.com/drapterlagas/DRAPTER-XMD)!  
╰─🛠️ *Prefix:* \`${prefix}\`

> _© MADE BY ⓃⒺCⓉOR🍯`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/i8c2ao.jpeg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('254725474072', '254725474072', '254725474072');
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("254725474072")){
  if(isReact) return
  m.react("💙")
   }
  //==========public react============//
