...
console.log("CONNECTING DRAPTER-XMD 🧬...");
...
console.log('DRAPTER-XMD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ DRAPTER-XMD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*
...
//================ownerreact==============
if(senderNumber.includes("25477777777")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("254777777777")){
if(isReact) return
m.react("👑")
}
