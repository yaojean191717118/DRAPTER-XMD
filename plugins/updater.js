    ...
    if (cmd === "update") {
        ...
        try {
            ...
            const { data: commitData } = await axios.get(
                "https://api.github.com/repos/drapterlagas/DRAPTER-XMD/commits/main"
            );
            ...
            const response = await axios({
                method: 'get',
                url: "https://github.com/drapterlagas/DRAPTER-XMD/archive/main.zip",
                responseType: 'stream'
            });
            ...
            const sourcePath = path.join(extractPath, "DRAPTER-XMD-main");
