...
const BOT_NAME = "DRAPTER-XMD";
const DEFAULT_THUMBNAIL = "https://files.catbox.moe/9n2k7a.jpg";
...
const createContext = (userJid, options = {}) => ({
    contextInfo: {
        ...
        externalAdReply: {
            ...
            sourceUrl: options.sourceUrl || "https://wa.me/254725474072", // link to bot or business
